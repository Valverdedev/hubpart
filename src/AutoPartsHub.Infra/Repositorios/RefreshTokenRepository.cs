...
/// e adiciona apenas a query específica de busca por hash do token.
/// </summary>
...
{
    public async Task<RefreshToken?> ObterPorHashAsync(string tokenHash, CancellationToken ct = default)
    {
